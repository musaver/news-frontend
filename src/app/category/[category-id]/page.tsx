        ...
        <div className="bg-[#f7fafc] relative w-full h-[75px]" data-name="Category - Desktop">
          <div className="absolute h-[75px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-full max-w-[1320px] px-6" data-name="CMS">
            ...
            <div className="absolute h-[22px] left-[24px] overflow-clip top-1/2 translate-y-[-50%]" data-name="Left Text">
              ...
              <div className="absolute flex flex-col font-normal h-[22px] justify-center leading-[0] left-[14px] not-italic text-[#020a1c] text-[14.25px] top-[11px] translate-y-[-50%] whitespace-nowrap">
                <p className="leading-[22px]">{category.name}</p>
              </div>
            </div>
        ...
        <div className="md:hidden px-4 py-6 space-y-12 max-w-[480px] mx-auto">
          {categoryArticles.length > 0 ? (
            <>
              ...
              <LatestNewsSection mockImages={mockImages} articles={categoryArticles} />
            </>
          ) : (
