      ...
      {isAuthor ? (
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 border border-[rgba(203,213,225,0.35)] rounded-[12px]">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#020a1c] text-[24px] leading-[30px] font-normal">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white p-6 border border-[rgba(203,213,225,0.35)] rounded-[12px]">
              <h3 className="text-[#020a1c] text-[20px] leading-[24px] font-normal mb-4">
                5 Recent Articles
              </h3>
                  ...
                  recentArticles.map(article => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span className={`inline-block mt-1 px-2 py-0.5 rounded text-[11px] font-medium ${article.status === 'published'
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-[#cc0000] to-[#990000] rounded-[12px] p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-[28px] leading-[36px] font-normal mb-2">
              ...
              <div className="hidden md:block bg-white/20 backdrop-blur-sm rounded-lg p-4">
                ...
                <p className="text-[32px] leading-[40px] font-bold">0 🔥</p>
