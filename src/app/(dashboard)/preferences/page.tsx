    ...
    <>
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 border border-[rgba(203,213,225,0.35)] rounded-[12px]">
          <h3 className="text-[#020a1c] text-[18px] leading-[24px] font-normal mb-6">
            Account Settings
          </h3>
        ...
        <div className="p-6 border border-[rgba(203,213,225,0.35)] rounded-[12px] bg-gradient-to-br from-[#cc0000] to-[#990000] text-white">
          <div className="flex items-start justify-between">
            <div>
              <h3 className="text-[20px] leading-[26px] font-normal mb-2">
                Become an Author
              </h3>
              ...
              <Link href="/become-an-author" className="px-4 py-2 bg-white text-[#cc0000] hover:bg-white/90 rounded-lg text-[14px] font-semibold transition-colors inline-block">
                Apply Now
              </Link>
            </div>
