...
export default function BecomeAnAuthorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate form
    if (!formData.fullName || !formData.email || !formData.designation || !formData.bio || !formData.address) {
        ...
        <div className="bg-[#f7fafc] relative w-full h-[75px]" data-name="Category - Desktop">
          <div className="absolute h-[75px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-full max-w-[1320px] px-6" data-name="CMS">
            ...
            <div className="hidden md:block absolute bottom-[-5px] h-[84px] right-[24px] w-fit" data-name="Mask Group">
              ...
              >
                <p className="leading-[84px]" style={{ color: 'rgba(0, 0, 0, 0)', WebkitTextStroke: '0.7px rgb(101 114 133)' }}>Become an Author</p>
              </div>
              <p className="leading-[84px]" style={{ color: 'rgba(0, 0, 0, 0)', fontSize: '78px' }}>Become an Author</p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-[341.73px_1px_1fr] gap-x-[24px] w-full">
              ...
              <div className="flex flex-col gap-[42px] items-start overflow-clip pl-[19px]">
                ...
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                  ...
                  {/* Application Form */}
                  <div className="box-border content-stretch flex flex-col items-start pb-0 pt-[42px] px-0 relative shrink-0 w-full">
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                      <h3 className="text-[20px] font-bold text-[#020a1c] mb-6">Apply to Become an Author</h3>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4 w-full">
                        ...
                        <div className="pt-2">
                          <button
                            ...
                            className="px-6 py-3 bg-[#cc0000] text-white rounded-lg font-medium hover:bg-[#b30000] disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                          >
