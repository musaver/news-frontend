          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {loadingHeader ? (
                ...
                <>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-y-3 sm:gap-x-4">
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                        ...
                        {authorData.author && (
                          ...
                          >
                            ...
                            <span className="text-[13px] font-semibold text-[#020a1c]">
                        ...
                        <div className="flex items-center gap-2 whitespace-nowrap">
                          <div className="w-[3px] h-[3px] bg-[#cc0000] rounded-full shrink-0"></div>
                          <ArticleDate>{formatFullDate(authorData.publishedAt)}</ArticleDate>
                        </div>

                        <div className="flex items-center gap-2 whitespace-nowrap">
                          <div className="w-[3px] h-[3px] bg-[#cc0000] rounded-full shrink-0"></div>
                          <ArticleDate>{authorData.readingTime}</ArticleDate>
                        </div>
                      </div>
                    )}
                  ...
                  {/* Mobile Share Row (Static - below title) */}
                    ...
                    <div className="lg:hidden flex items-center gap-3 pt-2">
                      ...
                      <div className="flex items-center gap-2.5 overflow-x-auto no-scrollbar py-1">
                        <button
                          ...
                          className="w-8 h-8 shrink-0 rounded-full border border-[rgba(203,213,225,0.35)] flex items-center justify-center hover:bg-[#f7fafc]"
                        >
                          <svg className="w-4 h-4 text-[#657285]" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          ...
                          className="w-8 h-8 shrink-0 rounded-full border border-[rgba(203,213,225,0.35)] flex items-center justify-center hover:bg-[#f7fafc]"
                        >
                          <svg className="w-4 h-4 text-[#657285]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                        </button>
                        <button
                          onClick={() => handleShare('copy')}
                          className={`w-8 h-8 shrink-0 rounded-full border flex items-center justify-center transition-all ${copied ? 'bg-green-50 border-green-200 text-green-600' : 'border-[rgba(203,213,225,0.35)] text-[#657285] hover:bg-[#f7fafc]'}`}
                        >
                          {copied ? (
              ...
              <div className="relative flex gap-8">
                ...
                <div className="hidden lg:block">
                  <div className="sticky top-32 flex flex-col gap-4">
                    ...
                    <button
                      onClick={() => handleShare('copy')}
                      className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all ${copied ? 'bg-green-50 border-green-200 text-green-600' : 'border-[rgba(203,213,225,0.35)] text-[#657285] hover:bg-[#f7fafc]'}`}
                    >
                      {copied ? (
                ...
                {/* Mobile Social Share Bar (Sticky Bottom) */}
                <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-t border-[rgba(203,213,225,0.35)] px-4 py-3 flex items-center justify-between shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
                  <div className="flex items-center gap-4 overflow-x-auto no-scrollbar">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        onClick={() => handleShare('facebook')}
                        className="w-9 h-9 shrink-0 rounded-full border border-[rgba(203,213,225,0.35)] flex items-center justify-center bg-white"
                      >
                        <svg className="w-4.5 h-4.5 text-[#657285]" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                        </svg>
                      </button>
                      ...
                      <button
                        ...
                        className="w-9 h-9 shrink-0 rounded-full border border-[rgba(203,213,225,0.35)] flex items-center justify-center bg-white"
                      >
                        <svg className="w-4.5 h-4.5 text-[#657285]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </button>
                      ...
                      <button
                        onClick={() => handleShare('copy')}
                        className={`w-9 h-9 shrink-0 rounded-full border flex items-center justify-center transition-all bg-white ${copied ? 'bg-green-50 border-green-200 text-green-600' : 'border-[rgba(203,213,225,0.35)] text-[#657285]'}`}
                      >
                        {copied ? (
