                  ...
                  {!loadingContent && contentData && (
                    <div className="lg:hidden flex items-center gap-3 pt-2">
                      ...
                      <div className="flex items-center gap-2.5">
                        <button className="w-8 h-8 rounded-full border border-[rgba(203,213,225,0.35)] flex items-center justify-center hover:bg-[#f7fafc]">
                ...
                <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-t border-[rgba(203,213,225,0.35)] px-4 py-3 flex items-center justify-between shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
                  <div className="flex items-center gap-4 overflow-x-auto no-scrollbar">
                    ...
                    <div className="flex items-center gap-3">
                      <button className="w-9 h-9 rounded-full border border-[rgba(203,213,225,0.35)] flex items-center justify-center bg-white">
