    ...
    <section className="bg-slate-200/20 py-12 md:py-12">
      <div className="max-w-[1320px] mx-auto px-4 md:px-6">
        <div className="flex items-center gap-5 mb-6 px-1 md:px-0">
          ...
          <Link href="/category/health" className="flex items-center gap-1 text-[12.8px] leading-[19px] md:text-sm text-slate-700 font-normal hover:text-[#cc0000] transition-colors cursor-pointer">
            <span>View all</span>
        ...
        <div className="hidden md:grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Link href={`/news-details/${featuredArticle.id}`} className="lg:col-span-2 relative block rounded-lg overflow-hidden h-[628px]">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white">
              ...
              <h3 className="text-xl leading-tight font-normal">
                {featuredArticle.title}
              </h3>
            </div>
          </Link>
