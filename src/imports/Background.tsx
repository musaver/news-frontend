import svgPaths from "./svg-ykc7st1had";
import img28AkoNpUShT9IbjEvRheIhenuoJpg from "figma:asset/73941a382715578176e34575c3db89f20f70b857.png";
...
import imgActiveKwt0VbnYGz3GrYMfUcfcVPwXsYgJpg from "figma:asset/ed68f97237e0e5aa15281e80b6e11b7af2f392e2.png";
import imgLhlizHiEArzAiqqDjs8R5WblwJpg from "figma:asset/8c3666ffe972ef2b025134c390a1715aafa53b20.png";
import imgFigurePhotoActive99Dz3ZcnkaQjNciOZnLHpaMIfoJpg from "figma:asset/273a0a9e1cc83c900858bd7491be7ba4442b38f9.png";
import imgActiveOjTcQe1QbgGuGobR9Ll7ZaywJpg from "figma:asset/424d7b0c69704458536f397a8e08661ce807f303.png";
import imgActiveL1AB8VgWhLrCxNg0BmZcC5AGxIwJpg from "figma:asset/6d00fa3c2d7790e1cd6b7cdb3f89652742305c58.png";
import imgActiveWsfqwRIu7Iq5Y5WQy0C9PwTeV7KJpg from "figma:asset/664b9a08e46e4b3de7283b1d6932c02951de3caf.png";
import imgActiveUfm8KVro1Mu0PDa2LcLhuRz5KaJpg from "figma:asset/05c36a373d23945257143833edf063f7326c736e.png";
...
import { imgOverlay, imgOverlay1, imgOverlay2 } from "./svg-n3odl";
...
function Container4() {
  return (
    <div className="h-[182.97px] overflow-clip relative shrink-0 w-[302.42px]" data-name="Container">
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal h-[183px] justify-center leading-[36.6px] left-0 not-italic text-[#020a1c] text-[27.891px] top-[90.69px] translate-y-[-50%] w-[282.81px]">
        <p className="mb-0">Small Businesses</p>
        <p className="mb-0">Flourish as US</p>
        <p className="mb-0">Government Expands</p>
        <p className="mb-0">Loan Access and</p>
        <p>Support</p>
      </div>
    </div>
  );
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[23px] not-italic relative shrink-0 text-[#020a1c] text-[14.375px] text-nowrap whitespace-pre">
        <p className="mb-0">In a year filled with economic challenges,</p>
        <p className="mb-0">small businesses across the United States</p>
        <p className="mb-0">are finding new opportunities for growth</p>
        <p>and expansion, thanks to the U.S.…</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[302.42px] overflow-clip relative shrink-0" data-name="Container">
      <Container5 />
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-col h-full items-start overflow-clip relative shrink-0" data-name="Content">
      <ArticleHeadlineArticle />
    </div>
  );
}

function Component28AkoNpUShT9IbjEvRheIhenuoJpg() {
  return (
...
function Active() {
  return (
    <div className="basis-0 grow min-h-px min-w-px overflow-clip relative rounded-[8px] shrink-0 w-[604.83px]" data-name="Active">
      <Component28AkoNpUShT9IbjEvRheIhenuoJpg />
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col h-[400px] items-start justify-center relative shrink-0" data-name="Container">
      <Active />
    </div>
  );
}
...
function FeaturedPhoto() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0" data-name="Featured Photo">
      <Container7 />
    </div>
  );
}

function LinkReadMoreAboutThisArticle() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center justify-center min-h-px min-w-px overflow-clip relative shrink-0" data-name="Link - Read more about this article.">
      <Content />
      <FeaturedPhoto />
    </div>
  );
...
function Featured() {
  return (
    <div className="content-stretch flex flex-col h-[400px] items-start justify-center relative shrink-0" data-name="Featured">
      <LinkReadMoreAboutThisArticle />
    </div>
  );
}

function SectionFeaturedCms() {
  return (
    <div className="content-stretch flex flex-col h-[400px] items-center relative shrink-0 w-full" data-name="Section - Featured CMS">
      <Featured />
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#020a1c] text-[14.25px] text-nowrap">
        <p className="leading-[22px] whitespace-pre">Latest News</p>
      </div>
    </div>
  );
}
...
function Dark() {
  return <div className="basis-0 bg-[rgba(203,213,225,0.35)] grow min-h-px min-w-px shrink-0 w-[708.09px]" data-name="Dark" />;
}
...
function ActiveWUSa65KrK8Qboe92Fcbj6LXpo2UJpg() {
  return (
...
function FigureContainer() {
  return (
    <div className="content-stretch flex h-[200px] items-center justify-center overflow-clip relative rounded-[8px] shrink-0 w-full" data-name="Figure - container">
      <ActiveWUSa65KrK8Qboe92Fcbj6LXpo2UJpg />
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[64.78px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal h-[65px] justify-center leading-[21.6px] left-0 not-italic text-[#020a1c] text-[0px] text-[16.594px] top-[31.59px] translate-y-[-50%] w-[281.62px]">
...
function LinkPhotoTextBelowDesktop() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Photo + Text Below [Desktop]">
      <FigureContainer />
      <Content1 />
    </div>
  );
...
function StoryWrapper() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[289.75px]" data-name="Story Wrapper">
      <LinkPhotoTextBelowDesktop />
    </div>
  );
}
...
function Container21() {
  return (
    <div className="h-[43.19px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal h-[44px] justify-center leading-[21.6px] left-0 not-italic text-[#020a1c] text-[16.875px] top-[20.8px] translate-y-[-50%] w-[229.42px]">
...
function LinkPhotoTextBelowDesktop1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Photo + Text Below [Desktop]">
      <FigureContainer1 />
      <Content2 />
...
function StoryWrapper1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[289.75px]" data-name="Story Wrapper">
      <LinkPhotoTextBelowDesktop1 />
    </div>
  );
}

function ActiveKwt0VbnYGz3GrYMfUcfcVPwXsYgJpg() {
  return (
...
function FigureContainer2() {
  return (
    <div className="content-stretch flex h-[200px] items-center justify-center overflow-clip relative rounded-[8px] shrink-0 w-full" data-name="Figure - container">
      <ActiveKwt0VbnYGz3GrYMfUcfcVPwXsYgJpg />
    </div>
  );
}
...
function Container25() {
  return (
    <div className="h-[43.19px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal h-[44px] justify-center leading-[21.6px] left-0 not-italic text-[#020a1c] text-[16.453px] top-[20.8px] translate-y-[-50%] w-[240.64px]">
...
function LinkPhotoTextBelowDesktop2() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Photo + Text Below [Desktop]">
      <FigureContainer2 />
      <Content3 />
...
function StoryWrapper2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[289.75px]" data-name="Story Wrapper">
      <LinkPhotoTextBelowDesktop2 />
    </div>
  );
}

function LatestNewsCms() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Latest News CMS">
      <StoryWrapper />
      <StoryWrapper1 />
      <StoryWrapper2 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#020a1c] text-[14.375px] text-nowrap">
        <p className="leading-[22px] whitespace-pre">Top Stories</p>
      </div>
    </div>
  );
}
...
function SectionTitleWithoutLine() {
  return (
    <div className="box-border content-stretch flex items-center justify-between overflow-clip pl-[2px] pr-[4px] py-0 relative shrink-0" data-name="Section Title → Without Line">
      <SectionTitle5 />
      <ViewAll1 />
    </div>
  );
...
function LhlizHiEArzAiqqDjs8R5WblwJpg() {
  return (
...
function HeadlineHeading4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Headline → Heading 4">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[21.6px] not-italic relative shrink-0 text-[16.875px] text-white w-full">
...
function LinkContainer() {
  return (
    <div className="absolute bottom-[23.99px] content-stretch flex flex-col gap-[2.8px] items-start left-[4.52%] overflow-clip right-[15.49%]" data-name="Link - Container">
...
function Active1() {
  return (
    <div className="h-[428.38px] overflow-clip relative rounded-[8px] shrink-0 w-full" data-name="Active">
      <LhlizHiEArzAiqqDjs8R5WblwJpg />
      <OverlayMaskGroup />
      <LinkContainer />
    </div>
  );
...
function LargeSectionPhoto() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[531.5px]" data-name="Large Section Photo">
      <Active1 />
    </div>
  );
}
...
function PhotoTopStories() {
  return (
    <div className="content-stretch flex items-start relative self-stretch shrink-0 w-[531.5px]" data-name="Photo - Top Stories">
      <LargeSectionPhoto />
    </div>
  );
}
...
function Container41() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[23px] not-italic relative shrink-0 text-[#020a1c] text-[16.594px] w-full">
        <p className="mb-0">Celebrity Collaborations Heat</p>
        <p className="mb-0">Up: Stars Team Up for</p>
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[23px] not-italic relative shrink-0 text-[#020a1c] text-[16.453px] w-full">
        <p className="mb-0">Streaming Services Unveil</p>
...
function Container49() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[23px] not-italic relative shrink-0 text-[#020a1c] text-[16.453px] w-full">
        <p className="mb-0">Congress Unites Across the</p>
        <p className="mb-0">Aisle to Pass Landmark Green</p>
        <p>Infrastructure Act, Paving Way…</p>
      </div>
    </div>
  );
}
...
function Articles() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-start overflow-clip p-[24px] relative rounded-[6px] shrink-0 w-[313.75px]" data-name="Articles">
      <ArticleTopStoriesCms />
    </div>
  );
}
...
function Content8() {
  return (
    <div className="content-stretch flex gap-[24px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Content">
      <PhotoTopStories />
      <Articles />
    </div>
  );
...
function SectionTopStories() {
  return (
    <div className="bg-[#f7fafc] relative rounded-[8px] shrink-0 w-full" data-name="Section - Top Stories">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-start p-[24px] relative w-full">
          <SectionTitleWithoutLine />
          <Content8 />
          <div className="absolute bottom-[-0.23%] left-0 right-0 rounded-[8px] top-0" data-name="Border">
...
function Content9() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start overflow-clip relative shrink-0 w-[917.25px]" data-name="Content">
      <SectionFeaturedCms />
      <LatestNews />
      <SectionTopStories />
    </div>
...
function FigurePhotoActive99Dz3ZcnkaQjNciOZnLHpaMIfoJpg() {
  return (
...
function LinkPhotoAssociatedWithThisSection() {
  return (
    <div className="content-stretch flex h-[250px] items-start relative shrink-0 w-full" data-name="Link - Photo associated with this section">
      <FigurePhotoActive99Dz3ZcnkaQjNciOZnLHpaMIfoJpg />
    </div>
  );
}
...
function Container51() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#020a1c] text-[14.875px] text-nowrap">
        <p className="leading-[22px] whitespace-pre">Finance</p>
      </div>
    </div>
  );
}
...
function SectionTitleWithoutLine1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Section Title → Without Line">
...
function Container57() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.25px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Finance</p>
      </div>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.25px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Sep 14, 2024</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.625px] w-full">
        <p className="mb-0">Federal Reserve Signals Potential Rate</p>
        <p>Cuts Amid Economic Resilience</p>
      </div>
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
          <ArticleHeadline7 />
        </div>
...
function Articles1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent />
      <Container61 />
    </div>
  );
}
...
function Container64() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.438px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Sep 4, 2024</p>
      </div>
    </div>
  );
}
...
function Container65() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.5px] w-full">
        <p className="mb-0">Stocks Surge as Investors Seek Growth</p>
        <p>Amid Rate Uncertainty</p>
      </div>
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles2() {
  return (
    <div className="content-stretch flex flex-col gap-[12.01px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent1 />
      <Container66 />
    </div>
  );
}
...
function Container69() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.438px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Aug 24, 2024</p>
      </div>
    </div>
  );
}
...
function Container70() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.5px] w-full">
        <p className="mb-0">The New York Stock Exchange buzzes</p>
        <p className="mb-0">with activity as U.S. markets reach new all-</p>
        <p>time highs</p>
      </div>
    </div>
  );
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles3() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent2 />
      <Container71 />
    </div>
  );
}
...
function Container74() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.25px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Aug 14, 2024</p>
      </div>
    </div>
  );
}
...
function Container75() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.625px] w-full">
        <p className="mb-0">Stocks Rebound as Market Eyes Potential</p>
        <p>Rate Cuts</p>
      </div>
    </div>
  );
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles4() {
  return (
    <div className="content-stretch flex flex-col gap-[12.01px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent3 />
      <Container76 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.625px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Aug 4, 2024</p>
      </div>
    </div>
  );
}
...
function Container80() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.5px] w-full">
        <p className="mb-0">Investors Eye Renewable Energy Stocks as</p>
        <p>Market Shifts to Green Economy</p>
      </div>
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles5() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent4 />
      <Container81 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.75px] w-full">
        <p className="mb-0">Market Optimism Grows as Fintech Trends</p>
        <p>Drive Future of Finance</p>
      </div>
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles6() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent5 />
      <Container86 />
    </div>
  );
}
...
function Container89() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.438px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Jul 27, 2024</p>
      </div>
    </div>
  );
}
...
function Container90() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.75px] w-full">
        <p className="mb-0">Saving Strategies to Build Wealth in a</p>
        <p>High-Interest Environment</p>
      </div>
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent6() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles7() {
  return (
    <div className="content-stretch flex flex-col gap-[12.01px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent6 />
      <Container91 />
    </div>
  );
}
...
function Container94() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[11.438px] text-nowrap">
        <p className="leading-[15.6px] whitespace-pre">Jul 26, 2024</p>
      </div>
    </div>
  );
}
...
function Container95() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.625px] w-full">
        <p className="mb-0">Smart Budgeting Tips to Maximize Your</p>
        <p>Savings in 2024</p>
      </div>
    </div>
  );
...
function StoryWrapperLinkTextOnlyDesktopSidebarContent7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Story Wrapper → Link - Text Only [Desktop Sidebar] → content">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center px-[4px] py-0 relative w-full">
...
function Articles8() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktopSidebarContent7 />
      <Container96 />
    </div>
  );
}

function FinanceNewsCms() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Finance News - CMS">
      <Articles1 />
      <Articles2 />
      <Articles3 />
      <Articles4 />
...
function AsideContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip relative shrink-0 w-full" data-name="Aside - Container">
      <LinkPhotoAssociatedWithThisSection />
      <SectionTitleWithoutLine1 />
      <FinanceNewsCms />
    </div>
  );
}

function SectionSidebarFinance() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative self-stretch shrink-0 w-[305.75px]" data-name="Section - Sidebar - Finance">
      <AsideContainer />
    </div>
  );
}
...
function Container97() {
  return (
    <div className="box-border content-stretch flex gap-[24px] items-start max-w-[1320px] overflow-clip px-[24px] py-[48px] relative shrink-0 w-[1320px]" data-name="Container">
      <Content9 />
      <Container50 />
      <SectionSidebarFinance />
    </div>
  );
}
...
function Container98() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#020a1c] text-[14.5px] text-nowrap">
        <p className="leading-[22px] whitespace-pre">Politics</p>
      </div>
    </div>
  );
}
...
function ActiveOjTcQe1QbgGuGobR9Ll7ZaywJpg() {
  return (
...
function FigureContainer3() {
  return (
    <div className="content-stretch flex h-[100px] items-start overflow-clip relative rounded-[8px] shrink-0 w-[125px]" data-name="Figure - container">
      <ActiveOjTcQe1QbgGuGobR9Ll7ZaywJpg />
    </div>
  );
}
...
function Container107() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.75px] w-full">
        <p className="mb-0">Rising Candidate</p>
        <p className="mb-0">Advocates Bold Vision</p>
        <p>Amid Economic…</p>
      </div>
    </div>
  );
...
function LinkSmallPhotoTextRightDesktop() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Small Photo + Text Right [Desktop]">
      <FigureContainer3 />
      <Content10 />
    </div>
  );
...
function StoryWrapper3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[306px]" data-name="Story Wrapper">
      <LinkSmallPhotoTextRightDesktop />
    </div>
  );
}

function ActiveL1AB8VgWhLrCxNg0BmZcC5AGxIwJpg() {
  return (
...
function FigureContainer4() {
  return (
    <div className="content-stretch flex h-[100px] items-start overflow-clip relative rounded-[8px] shrink-0 w-[125px]" data-name="Figure - container">
      <ActiveL1AB8VgWhLrCxNg0BmZcC5AGxIwJpg />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.875px] w-full">
        ...
        <p className="mb-0">Gains Momentum as</p>
        <p>Youth Support Surges</p>
      </div>
    </div>
  );
}
...
function LinkSmallPhotoTextRightDesktop1() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Small Photo + Text Right [Desktop]">
      <FigureContainer4 />
      <Content11 />
...
function StoryWrapper4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[306px]" data-name="Story Wrapper">
      <LinkSmallPhotoTextRightDesktop1 />
    </div>
  );
}

function ActiveWsfqwRIu7Iq5Y5WQy0C9PwTeV7KJpg() {
  return (
...
function FigureContainer5() {
  return (
    <div className="content-stretch flex h-[100px] items-start overflow-clip relative rounded-[8px] shrink-0 w-[125px]" data-name="Figure - container">
      <ActiveWsfqwRIu7Iq5Y5WQy0C9PwTeV7KJpg />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.875px] w-full">
        ...
        <p className="mb-0">Campaign Rebounds</p>
        <p>Amid Challenging Polls</p>
      </div>
    </div>
  );
}
...
function LinkSmallPhotoTextRightDesktop2() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Small Photo + Text Right [Desktop]">
      <FigureContainer5 />
      <Content12 />
...
function StoryWrapper5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[306px]" data-name="Story Wrapper">
      <LinkSmallPhotoTextRightDesktop2 />
    </div>
  );
}

function ActiveUfm8KVro1Mu0PDa2LcLhuRz5KaJpg() {
  return (
...
function FigureContainer6() {
  return (
    <div className="content-stretch flex h-[100px] items-start overflow-clip relative rounded-[8px] shrink-0 w-[125px]" data-name="Figure - container">
      <ActiveUfm8KVro1Mu0PDa2LcLhuRz5KaJpg />
    </div>
  );
}
...
function Container119() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[#020a1c] text-[14.375px] w-full">
        <p className="mb-0">Ava Mitchell’s Bold</p>
        <p className="mb-0">Economic Vision</p>
        <p>Resonates with Voters</p>
      </div>
    </div>
  );
}
...
function LinkSmallPhotoTextRightDesktop3() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Link - Small Photo + Text Right [Desktop]">
      <FigureContainer6 />
      <Content13 />
...
function StoryWrapper6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[306px]" data-name="Story Wrapper">
      <LinkSmallPhotoTextRightDesktop3 />
    </div>
  );
}

function PoliticsCms() {
  return (
    <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full" data-name="Politics CMS">
      <StoryWrapper3 />
      <StoryWrapper4 />
      <StoryWrapper5 />
      <StoryWrapper6 />
...
function SectionNameDatePosted23() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle29 />
      <Divider23 />
...
function ArticleHeadline21() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted23 />
      <Article22 />
    </div>
  );
}
...
function SectionNameDatePosted24() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle30 />
      <Divider24 />
...
function ArticleHeadline22() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted24 />
      <Article23 />
    </div>
  );
}
...
function SectionNameDatePosted25() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle31 />
      <Divider25 />
...
function ArticleHeadline23() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted25 />
      <Article24 />
    </div>
  );
}
...
function SectionNameDatePosted26() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle33 />
      <Divider26 />
...
function ArticleHeadline24() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted26 />
      <Article25 />
    </div>
  );
}
...
function SectionNameDatePosted27() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle34 />
      <Divider27 />
...
function ArticleHeadline25() {
  return (
    <div className="content-stretch flex flex-col gap-[4.01px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted27 />
      <Article26 />
    </div>
  );
}
...
function SectionNameDatePosted28() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle35 />
      <Divider28 />
...
function ArticleHeadline26() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted28 />
      <Article27 />
    </div>
  );
}
...
function SectionNameDatePosted29() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle36 />
      <Divider29 />
...
function ArticleHeadline27() {
  return (
    <div className="content-stretch flex flex-col gap-[4.01px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted29 />
      <Article28 />
    </div>
  );
}
...
function Overlay2() {
  return <div className="absolute bg-[#020a1c] inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%] mask-size-[100%_100%] rounded-[12px]" data-name="Overlay" style={{ maskImage: `url('${imgOverlay2}')` }} />;
}

function OverlayMaskGroup2() {
  return (
    <div className="absolute inset-0" data-name="Overlay:mask-group">
      <Overlay2 />
    </div>
...
function SectionNameDatePosted30() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle37 />
      <Date30 />
...
function ActiveIHOlyDcj050N5XfipAyaWShJaJpg1() {
  return (
...
function FigureContainer12() {
  return (
    <div className="content-stretch flex h-[100px] items-start overflow-clip relative rounded-[8px] shrink-0 w-[125px]" data-name="Figure - container">
      <ActiveIHOlyDcj050N5XfipAyaWShJaJpg1 />
    </div>
  );
}
...
function SectionNameDatePosted31() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle38 />
      <Divider31 />
...
function ArticleHeadline28() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted31 />
      <Article29 />
    </div>
  );
}
...
function SectionNameDatePosted32() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle39 />
      <Divider32 />
...
function ArticleHeadline29() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted32 />
      <Article30 />
    </div>
  );
}
...
function SectionNameDatePosted33() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle40 />
      <Divider33 />
...
function ArticleHeadline30() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted33 />
      <Article31 />
    </div>
  );
}
...
function SectionNameDatePosted34() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle41 />
      <Divider34 />
...
function ArticleHeadline31() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted34 />
      <Article32 />
    </div>
  );
}
...
function SectionNameDatePosted35() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle43 />
      <Divider35 />
...
function ArticleHeadline32() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted35 />
      <Article33 />
    </div>
  );
}
...
function SectionNameDatePosted36() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle44 />
      <Divider36 />
...
function ArticleHeadline33() {
  return (
    <div className="content-stretch flex flex-col gap-[4.01px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted36 />
      <Article34 />
    </div>
  );
}
...
function SectionNameDatePosted37() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle46 />
      <Divider37 />
...
function ArticleHeadline34() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted37 />
      <Article35 />
    </div>
  );
}
...
function SectionNameDatePosted38() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle47 />
      <Divider38 />
...
function ArticleHeadline35() {
  return (
    <div className="content-stretch flex flex-col gap-[4.01px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted38 />
      <Article36 />
    </div>
  );
}
...
function SectionNameDatePosted39() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle49 />
      <Divider39 />
...
function ArticleHeadline36() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted39 />
      <Article37 />
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktop12() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="Story Wrapper → Link - Text Only [Desktop]">
      <Content33 />
    </div>
...
function SectionNameDatePosted40() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle50 />
      <Divider40 />
...
function ArticleHeadline37() {
  return (
    <div className="content-stretch flex flex-col gap-[4.01px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted40 />
      <Article38 />
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktop13() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="Story Wrapper → Link - Text Only [Desktop]">
      <Content34 />
    </div>
...
function Articles10() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Articles">
      <StoryWrapperLinkTextOnlyDesktop12 />
      <StoryWrapperLinkTextOnlyDesktop13 />
    </div>
  );
}
...
function SectionNameDatePosted41() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle52 />
      <Divider41 />
...
function ArticleHeadline38() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted41 />
      <Article39 />
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktop14() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="Story Wrapper → Link - Text Only [Desktop]">
      <Content35 />
    </div>
...
function SectionNameDatePosted42() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full" data-name="Section Name + Date Posted">
      <SectionTitle53 />
      <Divider42 />
...
function ArticleHeadline39() {
  return (
    <div className="content-stretch flex flex-col gap-[4.01px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Article - headline">
      <SectionNameDatePosted42 />
      <Article40 />
    </div>
  );
}
...
function StoryWrapperLinkTextOnlyDesktop15() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="Story Wrapper → Link - Text Only [Desktop]">
      <Content36 />
    </div>
...
function ArticlesCms1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Articles CMS">
      <StoryWrapperLinkTextOnlyDesktop14 />
      <StoryWrapperLinkTextOnlyDesktop15 />
    </div>
  );
}
...
function MainMain() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-center left-0 pb-0 pt-[104px] px-0 top-0" data-name="Main - Main">
      <Container97 />
      <SectionPoliticsNews />
      <SectionHealthNews />
...
function RedLine() {
  return <div className="h-[5px] shrink-0 w-full z-[2]" data-name="Red Line" />;
}

function ContentBullet11() {
  return <div className="bg-[#cc0000] h-[15px] shrink-0 w-[4px]" data-name="content → bullet" />;
}
...
function Container279() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14.5px] text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">Subscribe to NewsFlash</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.8)] w-full">
        ...
        <p className="mb-0">{`Whether it’s business, politics, fashion, tech or finance, `}</p>
        <p>we deliver it in a flash—straight to your inbox.</p>
      </div>
    </div>
  );
}
...
function TitleText() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start overflow-clip relative shrink-0 w-full" data-name="Title + Text">
      <WithoutViewAll />
      <Container281 />
    </div>
  );
...
function Container282() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.8)] w-full">
...
function Input() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0)] grow min-h-px min-w-px relative rounded-[8px] self-stretch shrink-0" data-name="Input">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-start pl-[15px] pr-[115px] py-[15px] relative size-full">
          <Container282 />
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none shadow-[0px_0px_0px_1px_inset_rgba(101,114,133,0.75)]" />
    </div>
  );
}
...
function Input1() {
  return (
    <div className="basis-0 bg-[#cc0000] box-border content-stretch flex grow items-start justify-center min-h-px min-w-px overflow-clip pl-[15px] pr-[8.61px] py-[10.5px] relative rounded-[4px] shrink-0 w-[100px]" data-name="Input">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white">
...
function Form() {
  return (
    <div className="basis-0 content-stretch flex grow items-start justify-center min-h-px min-w-px relative shrink-0" data-name="Form">
      <Input />
      <Container283 />
    </div>
  );
...
function Container285() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 top-0 translate-x-[-50%] w-[351px]" data-name="Container">
      <Container284 />
    </div>
  );
}
...
function Input2() {
  return (
    <div className="basis-0 grow min-h-px min-w-px overflow-clip relative shrink-0 w-[351px]" data-name="Input">
      <Container285 />
    </div>
  );
}
...
function Container286() {
  return (
    <div className="content-stretch flex flex-col h-[45px] items-start justify-center relative shrink-0" data-name="Container">
      <Input2 />
    </div>
  );
}
...
function Newsletter() {
  return (
    <div className="content-stretch flex items-start relative self-stretch shrink-0 w-[375px]" data-name="Newsletter">
      <Content38 />
    </div>
  );
}

function ContentBullet12() {
  return <div className="bg-[#cc0000] h-[15px] shrink-0 w-[4px]" data-name="content → bullet" />;
}
...
function Container290() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[15.25px] text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">Company</p>
      </div>
    </div>
  );
}
...
function CompanySocialMedia() {
  return (
    <div className="content-stretch flex items-start justify-center overflow-clip relative shrink-0" data-name="Company + Social Media">
      <Company />
    </div>
  );
}
...
function Container304() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14.625px] text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">Categories</p>
      </div>
    </div>
  );
}
...
function EntertainmentLinkLight() {
  return (
...
function Categories() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start overflow-clip relative shrink-0" data-name="Categories">
      <WithoutViewAll2 />
      <NavMenuItems />
    </div>
  );
...
function Container327() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14.75px] text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">Social Media</p>
      </div>
    </div>
  );
}
...
function Container330() {
  return <div className="shrink-0 size-[18px]" data-name="Container" />;
}
...
function SocialMedia() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start justify-center overflow-clip relative shrink-0" data-name="Social Media">
      <Container329 />
      <MenuItems1 />
    </div>
  );
...
function FooterLinks() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0" data-name="Footer Links">
      <Container350 />
    </div>
  );
}

function NewsletterFooterLinks() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Newsletter + Footer Links">
      <Newsletter />
      <FooterLinks />
    </div>
  );
...
function Container359() {
  return <div className="shrink-0 size-[14px]" data-name="Container" />;
}
...
function LinkRightColumn() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-center overflow-clip relative shrink-0" data-name="Link - Right Column">
      <Container358 />
      <Container359 />
      <Container361 />
    </div>
...
function Content39() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[100px] items-start max-w-[1320px] overflow-clip pb-[24px] pt-[80px] px-[24px] relative shrink-0 w-[1320px] z-[1]" data-name="Content">
      <NewsletterFooterLinks />
      <Copyright1 />
    </div>
  );
}
...
function FooterActive() {
  return (
    <div className="absolute bg-[#020a1c] content-stretch flex flex-col isolate items-center justify-center left-0 overflow-clip right-0 top-[4519.72px]" data-name="Footer - Active">
      <RedLine />
      <Content39 />
    </div>
  );
...
function SiGyvS0GQpbAp07Rwk6Yg8XxhoSvg() {
  return (
    <div className="h-[29.844px] relative shrink-0 w-[175px]" data-name="SIGyvS0gQpbAp07Rwk6YG8Xxho.svg">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 175 30">
        <g clipPath="url(#clip0_1_4899)" id="SIGyvS0gQpbAp07Rwk6YG8Xxho.svg">
          <path d={svgPaths.p1a725800} fill="var(--fill-0, black)" id="Vector" />
          <path d={svgPaths.p111e0c00} fill="var(--fill-0, #CC0000)" id="Vector_2" />
        </g>
        <defs>
...
function SiGyvS0GQpbAp07Rwk6Yg8XxhoSvgFill() {
  return (
    <div className="box-border content-stretch flex flex-col h-[40.63px] items-center justify-center overflow-clip px-0 py-[5.393px] relative shrink-0 w-[175px]" data-name="SIGyvS0gQpbAp07Rwk6YG8Xxho.svg fill">
      <SiGyvS0GQpbAp07Rwk6Yg8XxhoSvg />
    </div>
  );
}
...
function NewsFlashLogo() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start overflow-clip" data-name="NewsFlash Logo">
      <SiGyvS0GQpbAp07Rwk6Yg8XxhoSvgFill />
    </div>
  );
}
...
function LinkLogo() {
  return (
    <div className="absolute h-[40.63px] left-[572.5px] overflow-clip top-[calc(50%+0.005px)] translate-y-[-50%] w-[175px]" data-name="Link - Logo">
      <NewsFlashLogo />
    </div>
  );
}
...
function Container362() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[12px] w-full">
        <p className="leading-[12px]">September 27 - 06:54 AM</p>
      </div>
    </div>
  );
}
...
function LeftContent() {
  return (
    <div className="absolute content-stretch flex flex-col h-[15px] items-start left-[24px] overflow-clip top-1/2 translate-y-[-50%] w-[200px]" data-name="Left Content">
      <Container362 />
    </div>
  );
}
...
function Container363() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#657285] text-[12px] text-nowrap">
        <p className="leading-[12px] whitespace-pre">New York, US: 20.2°C</p>
      </div>
    </div>
  );
}
...
function CityWeather() {
  return (
    <div className="content-stretch flex flex-col h-[15px] items-start justify-center relative shrink-0" data-name="City + Weather">
      <Container364 />
    </div>
  );
}
...
function RightContent() {
  return (
    <div className="absolute content-stretch flex items-center justify-end left-[1096px] overflow-clip top-1/2 translate-y-[-50%] w-[200px]" data-name="Right Content">
      <CityWeather />
    </div>
  );
}
...
function Container365() {
  return (
    <div className="bg-white h-full max-w-[1320px] overflow-clip relative shrink-0 w-[1320px]" data-name="Container">
      <LinkLogo />
      <LeftContent />
      <RightContent />
    </div>
...
function Container366() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[0px] text-nowrap text-white">
        <p className="leading-[18.2px] text-[12.469px] whitespace-pre">Latest News</p>
      </div>
    </div>
  );
}
...
function LinkLight() {
  return (
    <div className="box-border content-stretch flex h-[18.19px] items-center justify-center overflow-clip pb-px pt-0 px-0 relative shrink-0" data-name="Link - Light">
      <Container367 />
    </div>
  );
}
...
function TopStories() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Top Stories">
      <LinkLight />
    </div>
  );
}
...
function Light() {
  return <div className="basis-0 bg-[rgba(255,255,255,0.8)] grow min-h-px min-w-px shrink-0 w-full" data-name="Light" />;
}

function Container368() {
  return (
    <div className="content-stretch flex flex-col h-[14px] items-start justify-center relative shrink-0 w-px" data-name="Container">
      <Light />
    </div>
  );
}
...
function Business() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Business">
      <LinkLight1 />
    </div>
  );
}
...
function Finance() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Finance">
      <LinkLight2 />
    </div>
  );
}
...
function Health() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Health">
      <LinkLight3 />
    </div>
  );
}
...
function Politics() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Politics">
      <LinkLight4 />
    </div>
  );
}
...
function Fashion() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Fashion">
      <LinkLight5 />
    </div>
  );
}
...
function RealEstate() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Real Estate">
      <LinkLight6 />
    </div>
  );
}
...
function Travel1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Travel">
      <LinkLight7 />
    </div>
  );
}
...
function Entertainment1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Entertainment">
      <LinkLight8 />
    </div>
  );
}
...
function Sports1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Sports">
      <LinkLight9 />
    </div>
  );
}
...
function Tech1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Tech">
      <LinkLight10 />
    </div>
  );
}
...
function Container389() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[0px] text-nowrap text-white">
        <p className="leading-[18.2px] text-[12.797px] whitespace-pre">Podcast</p>
      </div>
    </div>
  );
}
...
function Podcast() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Podcast">
      <LinkLight11 />
    </div>
  );
}
...
function CategoryMenu() {
  return (
    <div className="box-border content-stretch flex gap-[24px] items-center justify-center pl-0 pr-[60px] py-0 relative shrink-0" data-name="Category Menu">
      <TopStories />
      <Container368 />
      <Business />
      <Finance />
...
function Light1() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex items-center justify-center overflow-clip relative rounded-[99px] shrink-0 size-[30px]" data-name="Light">
      <Container391 />
...
function Container393() {
  return (
    <div className="box-border content-stretch flex gap-[24px] items-center justify-center max-w-[1320px] px-[24px] py-0 relative shrink-0 w-[1320px]" data-name="Container">
      <CategoryMenu />
      <Container392 />
    </div>
  );
...
function NavSubnavBar() {
  return (
    <div className="bg-[#cc0000] content-stretch flex h-[40px] items-center justify-center overflow-x-auto overflow-y-clip relative shrink-0 w-full z-[1]" data-name="Nav - Subnav Bar">
      <Container393 />
      <div className="absolute inset-0" data-name="Border">
        <div aria-hidden="true" className="absolute border-[1px_0px] border-[rgba(203,213,225,0.2)] border-solid inset-0 pointer-events-none" />
      </div>
    </div>
  );
}
...
function NavDesktop() {
  return (
    <div className="content-stretch flex flex-col isolate items-center overflow-clip relative shrink-0 w-full" data-name="Nav - Desktop">
      <NavTopnavBar />
      <NavSubnavBar />
    </div>
  );
...
function Container394() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[1920px]" data-name="Container">
      <NavDesktop />
    </div>
  );
}
...
function Container395() {
  return <div className="absolute bottom-[3823.72px] h-[38px] left-[1758px] w-[142px]" data-name="Container" />;
}
...
export default function Background() {
  return (
    <div className="bg-white relative size-full" data-name="Background">
      ...
      <Container395 />
      <MainMain />
      <div className="absolute left-[calc(50%+0.005px)] size-[0.01px] top-[4519.72px] translate-x-[-50%]" data-name="Rectangle" />
      <FooterActive />
    </div>
  );
}