import imgUo4KHKvmrD87Exvy5Z2RMEpvtsJpg from "figma:asset/421b0848a3b25bc10de8bcbade363429c487b35a.png";
  ...
  return (
    <div className="absolute inset-0 rounded-[8px]" data-name="Uo4kHKvmrD87exvy5Z2rMEpvts.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[8px]">
        <img alt="" className="absolute h-full left-[-5.87%] max-w-none top-0 w-[111.73%]" src={imgUo4KHKvmrD87Exvy5Z2RMEpvtsJpg} />
      </div>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#020a1c] text-[12.8px] text-nowrap">
        <p className="leading-[18.2px] whitespace-pre">Experience: 3 Years</p>
      </div>
    </div>
  );
}
