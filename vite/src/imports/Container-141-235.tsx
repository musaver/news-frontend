import { imgContainer } from "./svg-ffj3m";
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Black',_sans-serif] font-black justify-center leading-[0] not-italic relative shrink-0 text-[65.898px] text-nowrap">
        <p className="leading-[84px] whitespace-pre">Podcast</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col items-start mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[270.28px_84px] right-[-0.72px]" data-name="Container" style={{ maskImage: `url('${imgContainer}')` }}>
      <Container2 />
    </div>
  );
}
...
function MaskGroup() {
  return (
    <div className="absolute bottom-[-5px] h-[84px] right-[24px] w-[270.28px]" data-name="Mask Group">
      <Container3 />
    </div>
  );
}
...
function Cms() {
  return (
    <div className="box-border content-stretch flex h-[75px] items-center max-w-[1320px] pl-[24px] pr-[1225.69px] py-[24px] relative shrink-0" data-name="CMS">
      <LeftText />
      <MaskGroup />
    </div>
  );
