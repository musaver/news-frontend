import imgUo4KHKvmrD87Exvy5Z2RMEpvtsJpg from "@/assets/9e475dacb59807df020b382d3379a34b034b6da1.png";
  ...
  return (
    <div className="absolute inset-0 rounded-[8px]" data-name="Uo4kHKvmrD87exvy5Z2rMEpvts.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[8px]">
        <img alt="" className="absolute h-[129.49%] left-0 max-w-none top-0 w-full" src={imgUo4KHKvmrD87Exvy5Z2RMEpvtsJpg.src} />
      </div>
    </div>
  );
}
