...
import { imgOverlay, imgOverlay1, imgOverlay2 } from "./svg-gsip3";
...
export default function MainMain() {
  return (
    <div className="box-border content-stretch flex flex-col items-center pb-0 pt-[104px] px-0 relative size-full" data-name="Main - Main">
      <Container97 />
      <SectionPoliticsNews />
      <SectionHealthNews />
