...
const HealthNewsSection = ({ mockImages }: HealthNewsSectionProps) => (
            ...
            {[
              ...
              <article key={index} className="flex gap-2">
                <div className="rounded-lg overflow-hidden w-[125px] h-[100px] flex-shrink-0 bg-slate-200">
                  <img 
                    src={`https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=125&h=100&fit=crop&seed=${index}`}
                    alt={article.title}
                    className="w-full h-full object-cover"
                  />
                </div>
